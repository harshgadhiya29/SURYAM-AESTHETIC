      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed">
              ...
              is on delivering transformative results with the highest standards
              of care.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link
                  to="/"
                  className="text-gray-300 hover:text-primary transition-colors flex items-center text-sm sm:text-base"
                >
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <Link
                  ...
                  className="text-gray-300 hover:text-primary transition-colors flex items-center text-sm sm:text-base"
                >
                  <span className="mr-2 text-primary">›</span> Gynecological
                  Treatments
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex">
                ...
                <span className="text-gray-300 text-sm sm:text-base leading-relaxed">
                  (A+B)17,Suryam Aesthetic Madhav Farm Road S.P.Ring Road
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6">
            <Link
              to="/"
              className="text-gray-400 text-xs sm:text-sm hover:text-primary transition-colors whitespace-nowrap"
            >
              Privacy Policy
            </Link>
            <Link
