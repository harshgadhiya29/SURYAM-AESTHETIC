    ...
    >
            ...
            >
              {formSubmitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-serif font-medium mb-4">Thank You!</h3>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button 
                      type="submit" 
                      className={`btn-primary w-full flex items-center justify-center ${loading ? 'opacity-75 cursor-wait' : ''}`}
                      disabled={loading}
                    >
                      {loading ? (
      ...
      <section className="py-20 bg-secondary-off">
        <div className="container-custom">
          ...
          <div className="bg-white rounded-lg shadow-medium overflow-hidden mt-12">
            <div className="h-[500px] w-full">
              ...
              <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">123 Elegance Avenue, Luxury District, City, Country</p>
                </div>
              </div>
            </div>
          </div>
