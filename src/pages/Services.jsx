...
const Services = () => {
  ...
  const ServiceNavigation = () => (
    <div className="bg-white shadow-soft rounded-lg p-6 sticky top-24">
      <h3 className="text-xl font-serif font-medium mb-4">Service Categories</h3>
      <ul className="space-y-2">
        {serviceCategories.map((category) => (
          <li key={category.id}>
            <a 
              href={`#${category.id}`}
              className="flex items-center py-2 px-4 rounded-md hover:bg-primary-50 hover:text-primary transition-colors"
            >
      ...
      <div className="mt-8 p-4 bg-primary-50 rounded-lg">
        ...
        <p className="text-sm text-gray-600 mb-4">Have questions about our services or need help choosing the right treatment?</p>
            ...
            <div className="lg:col-span-3">
              <div className="space-y-20">
                {serviceCategories.map((category, index) => (
                  <div key={category.id} id={category.id} ref={category.ref} className="scroll-mt-28">
                    <SectionTitle 
                ...
                <div className="bg-primary-50 rounded-lg p-8 text-center">
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-serif font-medium mb-3">Customized Treatment Packages</h3>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            >
              ...
              <h3 className="text-xl font-serif font-medium mb-3">1. Consultation</h3>
            ...
            >
              ...
              <h3 className="text-xl font-serif font-medium mb-3">2. Treatment</h3>
              <p className="text-gray-300">
            ...
            >
              ...
              <h3 className="text-xl font-serif font-medium mb-3">3. Aftercare</h3>
              <p className="text-gray-300">
